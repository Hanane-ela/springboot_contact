...
public class AddContactController {
			...
			BindingResult bindingResult,Model theModel)
	{
		...
		{
			theModel.addAttribute("erreur","Tous les champs sont obligatoires");
			return "add_contact";
		}
		...
		for(String phoneno : contactform.getPhonenumber())
		{
			...
			System.out.println("Numéro de téléphone créé pour le contact"+cphone.getPhoneID()  +cphone.getPhoneNo() );
