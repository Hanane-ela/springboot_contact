...
public class ContactsManagementApplication implements CommandLineRunner {
	...
	public void run(String... args) throws Exception {
		 ...
		 * user.setEmailid("mamadou@gmail.com");
		 * user.setPassword("barry");
		 * user.setPhoneno("AZERTY");
		 * log.info("Goint to save user ");
		 * user=userRepository.save(user);
		 * System.out.println("User id :"+ user.getUserid());
		 * Contact contact=new Contact();
		 * contact.setName("barry");
		 * contact.setEmailId("barry@gmail.com");
		 * contact.setUser(user);
		 * contact=contactRepository.save(contact);
		 * System.out.println("Contac ID "+contact.getContactId());
		 * ContactPhone contactPhone=new ContactPhone();
		 * contactPhone.setPhoneNo("06753422");
		 ...
		 * User tuser=new User();
		 * tuser.setUserid(1L);
		 * test.setEmailId("mamadou@gmail.com");
		 * test.setName("mamadou");
		 * test.setUser(tuser);
